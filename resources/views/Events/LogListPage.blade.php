                ...
                <div class="pagination-links">
                    <ul class="pagination">
                        ...
                        @if ($currentPage == $lastPage && $lastPage > 1)
                            <li class="page-item">
                                <a class="page-link" href="{{ $paginator->appends(request()->except('page'))->url(1) }}" title="В начало">
                                    <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
                        ...
                        @foreach ($pagesToShow as $page)
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $paginator->appends(request()->except('page'))->url($page) }}">{{ $page }}</a>
                                </li>
                            @endif
                        @endforeach
